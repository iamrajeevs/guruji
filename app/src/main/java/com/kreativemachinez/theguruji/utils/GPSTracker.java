...
/**
 * Created by regitroy on 03/07/17.
 */
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public GPSTracker(Context context, OnLocationChange onLocationChange) {
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                ...
                onLocationChange.locationChanged(new LatLng(latitude, longitude));
            }

        } catch (Exception e) {
            Log.e("LOCATION","NOT POSIBLE -> "+e.toString());
            e.printStackTrace();
        }
    ...
    public void onLocationChanged(Location location) {
        onLocationChange.locationChanged(new LatLng(location.getLatitude(), location.getLongitude()));
    }
